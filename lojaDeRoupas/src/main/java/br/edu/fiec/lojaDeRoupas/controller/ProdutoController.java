...
public class ProdutoController {
    ...
    public Produto buscarProdutoPorId(@RequestParam Integer id) {
    ...
    public void atualizar(@RequestParam Integer id, @RequestBody ProdutoDTO produtoDTO) {
    ...
    public void apagar(@RequestParam Integer id) {
